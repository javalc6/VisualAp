...
/**
 * 
 * This class provides a custom editor to handle file property for ReadFile
 * 
 * @author      javalc6
 * @version     1.2
 */
...
public class FileEditorX extends PropertyEditorSupport {

	protected File f;

	static public String getPath() {
		try {
			Preferences prefs = Preferences.userNodeForPackage(Class.forName("visualap.VisualAp"));
			return prefs.get("dataPath", System.getProperty("user.dir"));			
		} catch (Exception ex) {
			return System.getProperty("user.dir"); // backward compatibility with old VisualAp versions
		}
	}
...
// returns 20 if audio file
		...
		if (str.endsWith (".gif")) return 10;
		if (str.endsWith (".png")) return 10;
